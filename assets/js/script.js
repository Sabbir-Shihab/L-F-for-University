...
$(document).ready(function() {
    // Stable admin table action menus, including rows rebuilt by DataTables.
    document.addEventListener('click', function(e) {
        var toggle = e.target.closest('body.admin-layout .dropdown-toggle[data-bs-toggle="dropdown"]');
        if (!toggle || !toggle.closest('.table')) {
            return;
        }
